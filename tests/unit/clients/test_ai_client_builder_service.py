...
def _import_builder_service() -> type:
    ...
    sys.modules.pop("services.core.ai_client_builder_service", None)
    module = importlib.import_module("services.core.ai_client_builder_service")
...
def test_build_uses_default_model_when_no_override(
    ...
    monkeypatch.setattr(
        "services.core.ai_client_builder_service.AppConfigurationService",
        FakeConfig,
    )
    monkeypatch.setattr(
        "services.core.ai_client_builder_service.AIClient",
        FakeClient,
    )
