...
class TestReviewCodeService:
    ...
    def test_execute_reads_multiple_source_files(
        ...
        transformer.work_order_execution.return_value = "review request"
        ...
        request_source = transformer.work_order_execution.call_args.kwargs[
            "source_code"
        ]
    ...
    def test_execute_transforms_work_order_and_source_code(
        ...
        transformer.work_order_execution.assert_called_once()

        call = transformer.work_order_execution.call_args
    ...
    def test_execute_logs_llm_request_started(
        self,
        tmp_path: Path,
    ) -> None:
        """Log before submitting the review request to the LLM."""
        ...
        workspace = WorkSpace(
            root=tmp_path,
            work_order_id="worcs202608250007",
        )
    ...
    def test_execute_logs_llm_response_received(
        self,
        tmp_path: Path,
    ) -> None:
        """Log after receiving the review response from the LLM."""
        ...
        workspace = WorkSpace(
            root=tmp_path,
            work_order_id="worcs202608250008",
        )
    ...
    def test_execute_logs_execution_started(
        self,
        tmp_path: Path,
    ) -> None:
        """Log when Review Code execution begins."""
        ...
        workspace = WorkSpace(
            root=tmp_path,
            work_order_id="worcs202608250009",
        )
    ...
    def test_execute_logs_review_report_rendered(
        self,
        tmp_path: Path,
    ) -> None:
        """Log when the review report has been rendered."""
        ...
        workspace = WorkSpace(
            root=tmp_path,
            work_order_id="worcs202608250010",
        )
