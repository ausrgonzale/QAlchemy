...
def test_configuration_properties_are_exposed() -> None:
    ...
    assert service.templates.requirement_reports == (
        "requirement_eval_report_template.md"
    )
    assert service.templates.test_cases_reports == (
        "test_cases_analysis_report_template.md"
    )
