...
def _build_writer(
    ...
    *,
    ...
    (template_directory / template_name).write_text(template_text, encoding="utf-8")

    # ReportWriter computes template path from reporting.py directory.
    monkeypatch.setattr(reporting_module, "__file__", str(tmp_path / "reporting.py"))
