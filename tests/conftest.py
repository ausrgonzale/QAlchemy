...
APP_RESOURCES = Path(__file__).parent.parent / "resources"
...
@pytest.fixture
def requirements_work_order() -> str:
    """Provide a valid Work Order for RequirementsAgent unit tests."""

    return """QALCHEMY WORK ORDER

TASK
Evaluate the supplied requirement.
...
REQUIREMENT
The supplied requirement and its acceptance criteria.

DELIVERABLE
Provide a requirements assessment.
...
def sample_exception_code() -> str:
    """Provide the standard exception code used throughout unit tests."""

    return "CFG001"


# =============================================================================
# Agent Dependency Fixtures
# =============================================================================


@pytest.fixture
def client() -> Mock:
    """Provide a mocked Client for Agent unit tests."""

    return Mock()


@pytest.fixture
def provider_transformer() -> Mock:
    """Provide a mocked ProviderTransformer for Agent unit tests."""

    return Mock()


@pytest.fixture
def read_file_tool() -> Mock:
    """Provide a mocked ReadFileTool for Agent unit tests."""
...
def requirements_agent(
    client: Mock,
    provider_transformer: Mock,
    read_file_tool: Mock,
) -> RequirementsAgent:
    """Provide a RequirementsAgent for unit tests."""
    return RequirementsAgent(
        client=client,
        provider_transformer=provider_transformer,
